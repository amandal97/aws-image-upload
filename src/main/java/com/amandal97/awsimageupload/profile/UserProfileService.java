...
import com.amandal97.awsimageupload.bucket.BucketName;
import com.amandal97.awsimageupload.filestore.FileStore;
...
public class UserProfileService {
	...
	public void uploadUserProfileImage(UUID userProfileId, MultipartFile file) {
		...
		// Store the image in s3 bucket and update database with the s3 image link
